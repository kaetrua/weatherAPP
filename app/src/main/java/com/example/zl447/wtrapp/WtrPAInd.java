...
public class WtrPAInd implements ViewPager.OnPageChangeListener {

    private Context context;
    private ViewPager viewPager;
    private LinearLayout dotLayout;
    private int size;
    private int img1 = R.mipmap.littlepot2, img2 = R.mipmap.littlepot1;
    private int imgSize = 15;
    private List<ImageView> dotViewLists = new ArrayList<>();

    public WtrPAInd(Context context, ViewPager viewPager, LinearLayout dotLayout, int size) {
